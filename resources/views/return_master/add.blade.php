  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active" ><a href="{{Request::root()}}/return_master/add-return_master">Add Return_master</a></li>
      </ul>
  </div>
</nav>
...
<div class="container">
  ...
  <h2>Add Return_master</h2>  
<form role="form" method="post" action="{{Request::root()}}/return_master/add-return_master-post" >
