  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        <li><a href="{{Request::root()}}/unit_master">Manage Unit_master</a></li>
        <li class="active" ><a href="{{Request::root()}}/unit_master/add-unit_master">Add Unit_master</a></li>
      </ul>
  </div>
</nav>
