...
<div class="container">
  ...
  <h2>Update List</h2>  
<form role="form" method="post" action="{{Request::root()}}/list/edit-list-post" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
 <input type="hidden" value="<?php echo $list->id ?>"   name="list_id">


      <div class="form-group">
    <label for="name">Name:</label>
    <input type="text" value="<?php echo $list->name ?>" class="form-control" id="name" name="name">
  </div>
    <div class="form-group">
