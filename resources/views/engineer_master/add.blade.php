  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active" ><a href="{{Request::root()}}/engineer_master/add-engineer_master">Add Engineer_master</a></li>
      </ul>
  </div>
</nav>
...
<div class="container">
  ...
  <h2>Add Engineer_master</h2>  
<form role="form" method="post" action="{{Request::root()}}/engineer_master/add-engineer_master-post" >
    ...
    <input type="text" class="form-control" id="EngineerName" name="EngineerName">
  </div>
    <div class="form-group">
